...
function filter_smilies(s){
	for (var i = 0; i < smilies.length; i++){
		...
		var replace = '<img src="http://dlmooc.deeper-learning.org/wp-includes/images/smilies/' + smilies[i][1] + '" class="wp-smiley" border="0" style="border:none;" alt="' + smilies[i][0].replace(/\\/g, '') + '" />';
...
var GetChaturl = "http://dlmooc.deeper-learning.org/wp-content/plugins/simple-ajax-chat/simple-ajax-chat.php?sacGetChat=yes";
var SendChaturl = "http://dlmooc.deeper-learning.org/wp-content/plugins/simple-ajax-chat/simple-ajax-chat.php?sacSendChat=yes";
var httpReceiveChat;
var httpSendChat;
...
function checkName(){
	...
	if (currentName.value != sacCookie) {
		document.cookie = "sacUserName="+currentName.value+"; expires=Tue, 22 Dec 2015 21:37:22 UTC;"
	}
...
function checkUrl(){
	...
	if (currentName.value != sacCookie) {
		document.cookie = "sacUrl="+currentName.value+"; expires=Tue, 22 Dec 2015 21:37:22 UTC;"
		return;
	}
